...
export const standard2002Fr: YearFormatEntry = {
  ...
  representativeDecks: [
    ...
    },
    {
      ...
      archetype: 'control',
      summary:
        'Un deck control vert-blanc-bleu centré sur Mirari\'s Wake qui double le mana et pump les créatures. Wrath of God reset, Roar of the Wurm produit des tokens 6/6 difficiles à tuer via flashback, et Compulsion plus Deep Analysis rechargent la main. Inévitable face aux decks fair mais lent face au combo rapide.',
