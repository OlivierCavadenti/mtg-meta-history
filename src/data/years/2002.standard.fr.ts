  ...
  representativeDecks: [
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Psychatog' },
          { count: 4, name: 'Upheaval' },
          { count: 4, name: 'Fact or Fiction' },
          { count: 4, name: 'Counterspell' },
          { count: 4, name: 'Nightscape Familiar' },
          { count: 4, name: 'Force Spike' },
          { count: 3, name: 'Memory Lapse' },
          { count: 3, name: 'Repulse' },
          { count: 3, name: 'Cunning Wish' },
          { count: 2, name: 'Circular Logic' },
          { count: 1, name: 'Aether Burst' },
          { count: 4, name: 'Underground River' },
          { count: 4, name: 'Salt Marsh' },
          { count: 4, name: 'Darkwater Catacombs' },
          { count: 8, name: 'Island' },
          { count: 4, name: 'Swamp' },
        ],
        sideboard: [
    ...
    },
    {
      ...
      decklist: {
        ...
        sideboard: [
          ...
          { count: 3, name: 'Krosan Reclamation' },
        ],
        source: { title: 'Example list', url: '#', publisher: 'mtg-meta-history' },
      },
      source: {
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Cabal Coffers' },
          { count: 4, name: 'Corrupt' },
          { count: 4, name: 'Mind Sludge' },
          { count: 4, name: 'Mutilate' },
          { count: 4, name: 'Nantuko Shade' },
          { count: 4, name: 'Duress' },
          { count: 4, name: 'Diabolic Tutor' },
          { count: 3, name: 'Chainer\'s Edict' },
          { count: 3, name: 'Innocent Blood' },
          { count: 2, name: 'Haunting Echoes' },
          { count: 24, name: 'Swamp' },
        ],
        sideboard: [
          { count: 3, name: 'Engineered Plague' },
          { count: 3, name: 'Persecute' },
          { count: 3, name: 'Withered Wretch' },
          { count: 3, name: 'Coffin Purge' },
