...
export const standard2016Fr: YearFormatEntry = {
  ...
  representativeDecks: [
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 3, name: 'Jace, Vryn\'s Prodigy' },
          { count: 5, name: 'Plains' },
          { count: 4, name: 'Reflector Mage' },
          { count: 4, name: 'Spell Queller' },
          { count: 4, name: 'Sunpetal Grove' },
          { count: 4, name: 'Sylvan Advocate' },
        ],
        sideboard: [
          { count: 4, name: 'Duress' },
          { count: 4, name: 'Negate' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 3, name: 'Emrakul, the Promised End' },
          { count: 15, name: 'Forest' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 3, name: 'Declaration in Stone' },
          { count: 3, name: 'Gideon, Ally of Zendikar' },
          { count: 4, name: 'Languish' },
          { count: 3, name: 'Murderous Cut' },
          { count: 17, name: 'Plains' },
          { count: 3, name: 'Read the Bones' },
          { count: 3, name: 'Sorin, Grim Nemesis' },
          { count: 17, name: 'Swamp' },
          { count: 3, name: 'Thoughtseize' },
          { count: 4, name: 'Ultimate Price' },
        ],
        sideboard: [
          { count: 4, name: 'Duress' },
          { count: 4, name: 'Negate' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Always Watching' },
          { count: 4, name: 'Archangel Avacyn' },
          { count: 3, name: 'Declaration in Stone' },
          { count: 3, name: 'Gideon, Ally of Zendikar' },
          { count: 34, name: 'Plains' },
          { count: 4, name: 'Thalia\'s Lieutenant' },
          { count: 4, name: 'Thraben Inspector' },
          { count: 4, name: 'Town Gossipmonger' },
        ],
        sideboard: [
          { count: 4, name: 'Duress' },
          { count: 4, name: 'Negate' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Always Watching' },
          { count: 4, name: 'Archangel Avacyn' },
          { count: 4, name: 'Declaration in Stone' },
          { count: 3, name: 'Gideon, Ally of Zendikar' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 14, name: 'Forest' },
          { count: 4, name: 'Grim Flayer' },
          { count: 3, name: 'Ishkanah, Grafwidow' },
          { count: 3, name: 'Liliana, the Last Hope' },
          { count: 3, name: 'Murderous Cut' },
          { count: 3, name: 'Reflector Mage' },
          { count: 14, name: 'Swamp' },
          { count: 3, name: 'Sylvan Advocate' },
          { count: 3, name: 'Thoughtseize' },
          { count: 3, name: 'Traverse the Ulvenwald' },
          { count: 3, name: 'Vessel of Nascency' },
          { count: 4, name: 'Woodland Cemetery' },
        ],
        sideboard: [
          { count: 4, name: 'Duress' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 4, name: 'Reflector Mage' },
          { count: 4, name: 'Selfless Spirit' },
          { count: 4, name: 'Smuggler\'s Copter' },
          { count: 4, name: 'Spell Queller' },
        ],
        sideboard: [
          { count: 4, name: 'Duress' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Clifftop Retreat' },
          { count: 4, name: 'Cultivator\'s Caravan' },
          { count: 3, name: 'Declaration in Stone' },
          { count: 3, name: 'Gideon, Ally of Zendikar' },
          { count: 4, name: 'Inventor\'s Apprentice' },
