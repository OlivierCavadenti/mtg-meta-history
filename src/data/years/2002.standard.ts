...
export const standard2002: YearFormatEntry = {
  ...
  representativeDecks: [
    ...
    },
    {
      ...
      archetype: 'control',
      summary:
        'A green-white-blue control deck centered on Mirari\'s Wake doubling mana and pumping creatures. Wrath of God resets, Decree of Justice produces a finishing army of tokens, and Compulsion plus Deep Analysis refill the hand. Inevitable against fair decks but slow against fast combo.',
