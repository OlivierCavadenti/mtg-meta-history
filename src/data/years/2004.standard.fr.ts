    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 4, name: 'Great Furnace' },
          { count: 4, name: 'Glimmervoid' },
          { count: 4, name: 'Blinkmoth Nexus' },
        ],
        sideboard: [
          { count: 3, name: 'Pyroclasm' },
          { count: 3, name: 'Damping Matrix' },
          { count: 3, name: 'Terror' },
          { count: 3, name: 'Cabal Therapy' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 2, name: 'Darksteel Colossus' },
          { count: 2, name: 'Mephidross Vampire' },
          { count: 1, name: 'Kiki-Jiki, Mirror Breaker' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 4, name: 'Viridian Shaman' },
          { count: 4, name: 'Eternal Witness' },
          { count: 4, name: 'Wrath of God' },
          { count: 3, name: 'Oxidize' },
          { count: 4, name: 'Renewed Faith' },
          { count: 4, name: 'Krosan Tusker' },
          { count: 4, name: 'Sakura-Tribe Elder' },
        ...
        sideboard: [
          ...
          { count: 3, name: 'Akroma, Angel of Wrath' },
          { count: 3, name: 'Pulse of the Fields' },
