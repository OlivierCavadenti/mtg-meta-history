  ...
  representativeDecks: [
    {
      ...
      decklist: {
        mainboard: [
          { count: 4, name: 'Necropotence' },
          { count: 4, name: 'Dark Ritual' },
          { count: 4, name: 'Hymn to Tourach' },
          { count: 4, name: 'Hypnotic Specter' },
          { count: 4, name: 'Order of the Ebon Hand' },
          { count: 3, name: 'Drain Life' },
          { count: 3, name: 'Knight of Stromgald' },
          { count: 2, name: 'Sengir Vampire' },
          { count: 2, name: 'Nevinyrral\'s Disk' },
          { count: 4, name: 'Strip Mine' },
          { count: 18, name: 'Swamp' },
          { count: 4, name: 'Mishra\'s Factory' },
          { count: 4, name: 'Dark Banishing' },
        ],
        sideboard: [
          { count: 3, name: 'Gloom' },
          { count: 3, name: 'Serrated Arrows' },
          { count: 3, name: 'Dystopia' },
          { count: 3, name: 'Hyalopterous Lemure' },
    ...
    },
    {
      ...
      decklist: {
        mainboard: [
          ...
          { count: 4, name: 'Howling Mine' },
          { count: 3, name: 'Chronatog' },
          { count: 4, name: 'Counterspell' },
          { count: 4, name: 'Power Sink' },
